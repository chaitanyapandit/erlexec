...
init([Options]) ->
    ...
    {Exe,Msg} =
            ...
            not Root, User =/= undefined ->
                ...
                {lists:append(["/usr/bin/sudo PATH=$PATH ASDF_DATA_DIR=$ASDF_DATA_DIR -u ", U, " ", Exe0, Args]), undefined};
            SUID, EffUsr/="root", EffUsr/=User, User/=undefined, User/=root, User/="root" ->
                ...
                {lists:append(["/usr/bin/sudo PATH=$PATH ASDF_DATA_DIR=$ASDF_DATA_DIR ", Exe0, " -suid", Args]), undefined};
            true ->
                {Exe0 ++ Args, undefined}
            end,
    try
